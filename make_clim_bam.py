...
def save_nc(mast_u, mast_v, mast_t, lat_send, lev):
    ...
    f = cdf.Dataset('djf_climatological_mean_2003_2013.nc4', 'w', format='NETCDF4')
    ...
    for year in years:
        for month in months:
            ...
            for day in days:
                ...
                lat_hold, lon_hold, lev_hold, time_hold, tot_u_hold, tot_v_hold, t_hold = bam_merra_calc.call_main(month, year, day)
                if lat_hold[0] == 'n':
