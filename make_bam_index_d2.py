...
def save_eke(data_send, vt_send, u_send, uv_send, levels, lats):
    ...
    os.chdir(bam_data)
    f = cdf.Dataset(season+'_metrics_1981_1991.nc4', 'w', format='NETCDF4')
    ...
    for year in years:
        for month in months:
            ...
            for day in days:
                ...
                lat, lon, lev, time, u, v, t = bam_merra_calc_d2.call_main(month, year, day)
