"""
*This code is run after 'make_clim_bam_smal'. I am using it to take the output from that script 
...
def save_eke(data_send, vt_send, u_send, uv_send, levels, lats):
    ...
    f = cdf.Dataset('eke_data_year_.nc4', 'w', format='NETCDF4')
    ...
    for year in years:
        for month in months:
            ...
            for day in days:
                ...
                print(f_mean_u.shape)
                p= plt.imshow(f_mean_u)
