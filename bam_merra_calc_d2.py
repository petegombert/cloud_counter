...
merra_data_path = '/uufs/chpc.utah.edu/common/home/u1113223/merra_hold2'

def download_file(month, year, day):
    #print('starting '+month+'/'+year)
    os.chdir('/uufs/chpc.utah.edu/common/home/u1113223/merra_hold2')
    if int(year) < 1992:
