...
**This is a copy of 'bam_merra_calc.py' to see a more detailed reasoning for why there are multiple of these
files, see 'make_clim_bam_d2.py'
...
merra_data_path = '/uufs/chpc.utah.edu/common/home/u1113223/merra_hold_smal'

def download_file(month, year, day):
    #print('starting '+month+'/'+year)
    os.chdir('/uufs/chpc.utah.edu/common/home/u1113223/merra_hold_smal')
    if int(year) < 1992:
